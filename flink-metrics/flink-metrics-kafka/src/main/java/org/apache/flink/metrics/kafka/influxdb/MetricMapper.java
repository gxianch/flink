...
public class MetricMapper {
    ...
    public static MyPoint map(MeasurementInfo info, Instant timestamp, Gauge<?> gauge) {
        MyPoint.Builder builder = builder(info, timestamp);
    ...
    private static MyPoint.Builder builder(MeasurementInfo info, Instant timestamp) {

        return MyPoint.measurement(info.getName())
                .tag(info.getTags())
